...
type MovieInfoClient interface {
	...
	SetMovieInfo(ctx context.Context, in *MessageData, opts ...grpc.CallOption) (*Status, error)
}
...
func (c *movieInfoClient) SetMovieInfo(ctx context.Context, in *MessageData, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type MovieInfoServer interface {
	...
	SetMovieInfo(context.Context, *MessageData) (*Status, error)
...
func (UnimplementedMovieInfoServer) SetMovieInfo(context.Context, *MessageData) (*Status, error) {
...
func _MovieInfo_SetMovieInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieInfoServer).SetMovieInfo(ctx, req.(*MessageData))
	}
	return interceptor(ctx, in, info, handler)
}
